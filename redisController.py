...
import \
    tempfile  # another option (failed): #https://stackoverflow.com/questions/56972903/how-to-read-mkv-bytes-as-video/
import numpy as np
import cv2
...
class redisController:
    ...
    def readVideo(self, videoname):
        videoframe = self.r.get(videoname)
        img_np = np.frombuffer(videoframe, np.uint8)
